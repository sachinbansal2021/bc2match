...
$cssInline .= '';
$header = '
	<img title="Bizconnect Home" alt="Bizconnect Home" src="img/BizConLogo_0.jpg" style="border:0px;float:left;display:inline-block;position:absolute;margin-top:10px;margin-left:10px;z-Index:5;" />';
$topSocial = '
	<div id="topSocial">
		<ul>
...
$footer .= '
	...
	<br/>
	Copyright 2013, ______ All rights reserved.<br/><br/>

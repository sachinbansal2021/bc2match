...
// if first login, update status to 2 'evaluating'
if (intval(QV("SELECT usrapp_status FROM usr_app WHERE usrapp_usr_id = '".$_SESSION['usr_id']."'")) < 2 ) Q("UPDATE usr_app SET usrapp_status = '2' WHERE usrapp_usr_id='".$_SESSION['usr_id']."' ");

...
if ($dnQ) foreach($dnQ as $dn) $dbNav .= '	<li class="nav1 '.$dn['rescon_menustyle'].'"><p><a href="'.$dn['rescon_url'].'">'.$dn['rescon_menu'].'</a></p><div class="subtext">'.$dn['rescon_menusubtext'].'</div></li>';

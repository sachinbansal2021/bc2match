...
$cssInline .= '	 ' ;                                  //bc2match-logo-design-1.png
$header = '                       
...
<!--	<img title="BC2MatchDD_ " alt="BC2MatchDD" src="/img/bc2match-logo-design-1.png" style="border:0px;float:left;display:inline-block;position:relative;margin-top:10px;margin-left:10px;z-Index:6;" />
 
	</><img title="BC2MatchDDD_ " alt="BC2MatchDDD" src="./img/bc2match-logo-design-1.png" style="border:0px;float:left;display:inline-block;position:relative;margin-top:10px;margin-left:10px;z-Index:6;" />
<
<img title="BC2MatchEE_ " alt="BC2MatchEE" src="images/bc2match-logo-design-1.png" style="border:0px;float:left;display:inline-block;position:relative;margin-top:10px;margin-left:10px;z-Index:7;" />
<img title="BC2MatchEE_ " alt="BC2MatchEE" src="/images/bc2match-logo-design-1.png" style="border:0px;float:left;display:inline-block;position:relative;margin-top:10px;margin-left:10px;z-Index:7;" />
-->
	';
$topSocial = '
...
/*
	...
	<br/>
*/	
$footer .= '<br>&nbsp&nbspCopyright 2018, BC2 Match - All rights reserved. Contactus  <br/><br/>';
/*
...
if( $_SESSION['contactus'] == 1 || $template == "contactus")  $memberType = '(Public)';

switch ($_SESSION['usr_auth']) {
	case  "0":  default:    
	    // Public Users or maybe contact us
		$header .= '

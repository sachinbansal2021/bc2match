...
//$postedDate1 = "01/26/2020";
//$postedDate2 = "01/29/2020";

$url = "https://api.sam.gov/prod/opportunities/v1/search?limit=1000&api_key=v5CJrBw9mOiXqGxjIlkmyx0urI3v5nbsZHuBXcrO&postedFrom=".$postedDate."&postedTo=".$postedDate;
echo $url."<br>";
//exit();
...
for ($x = 0; $x < 200; $x++) {
    echo $fields[orglist][$x]['fhagencyorgname']."*".$fields[orglist][$x]['fhorgname']."<br>";
}


$data = file_get_contents('./a2.txt');
$fields = json_decode($data,true); // decode the JSON feed
...
for ($z = 0; $z < $totalrecs; $z++) 
{
    ...
    if ($y == 1000)
    {
        ...
        $offset += 1000;
        echo "<br>============>offset [".$offset."]<br>";
        $url = "https://api.sam.gov/prod/opportunities/v1/search?limit=1000&api_key=v5CJrBw9mOiXqGxjIlkmyx0urI3v5nbsZHuBXcrO&postedFrom=".$postedDate."&postedTo=".$postedDate."&offset=".$offset;

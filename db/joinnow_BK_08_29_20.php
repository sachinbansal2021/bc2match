...
*/            
            $content .= '</table>';
               ...
               <tr> <td align="center" width="780" colspan="1" >
                   ...
                   <tr> <td align="center" width="780" colspan="1" height="'.$headerheight.'">
                      <br>
                    <a href ="../join-now.htm">Return to BC2Match Join Now Page </a>                  
                  </td><tr>
     ...
     <strong class="dark-heading"> JOIN NOW Add your Company and up to 5 Seats</strong> <br></span>
		 </td></tr><tr><td>';
		   $custommessage= "message here";
		   ...
		   //<-- <input type="radio"   name="level" 	value="1"  ><span style="background-color:#f2f2f2;"> Silver</span>&nbsp; &nbsp;
	        ...
	        $content .= '<tr><td class="table-form-label">* Number of Seats: </td>
				<td >
		    	<input type="number" class="loginbox" style="text-align:center;" name="numberofseats" value="5" min="1" max="5"  title="Number of Seats" required readonly/></td></tr>
	         	</table>
	         	<table class="w-100">
       ...
       <center><a href ="../join-now.htm">Return to BC2Match Join Now Page </a>
       </center>
                             </td></tr>
                  </table> </div>';
            $content .= '  </div></div></div>';
                 ...
                 $content .= '  <tr> <td align="center" width="700" colspan="1" height="'.$headerheight.'" style="background-color: #dddddd; " >';
                    ...
                    $content .= '  <a href="'.$_SERVER['PHP_SELF'].$UseHREFreqs.'">Return to JoinNow Action Page</a>
                            ...
                            <br>   
                             ...
                             <a href ="../join-now.htm">Return to BC2Match Join Now Home Page </a>
...
<input class="loginbox" type="text" name="numberofseats" value="'. $_REQUEST['numberofseats'].'" required="true" readonly/></td></tr>	
